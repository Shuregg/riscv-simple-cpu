...
HD_PWD='D:/MIET-APS-Labs/LAB2_Register_file_and_memory/RegFile_and_memory.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log CYBERcobra.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source CYBERcobra.tcl -notrace
